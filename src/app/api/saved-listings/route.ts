...
import { removeSavedListingBySlug, saveListing } from "@/lib/server/social-service";
...
export async function DELETE(request: Request) {
  ...
  const result = await removeSavedListingBySlug(user.id, String(body.data.listingSlug));
